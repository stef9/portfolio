...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 01 apr 2019 om 13:01
...
(82, 'Gouttes d\'eau sur pierres brÃ»lantes', 86, 1999, 'Drama', 90),
(83, 'Great Expectations', 28, 1998, 'Romantiek', 108),
(84, 'Greetings', 88, 1968, 'Satire', 0),
(85, 'HÃ¤ndler der vier Jahreszeiten', 34, 1971, 'Drama', 89),
...
--
ALTER TABLE `acteurs`
  MODIFY `NR` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=301;
COMMIT;
