...
<header>
 ...
 <div class="card">
  <img src="http://www.boom.hr/images/orion-pet-raz2-15.jpg" alt="BOOM" style="width:85%">
  <h1>BOOM nitraten</h1>
  <p class="price"><?php
...
if ($result->num_rows > 0) {
  ...
  <p><button>Add to Cart</button></p>
      ...
      <div class="card">
      <img src="https://anypos-sbo.o.auroraobjects.eu/2/article/4228.1449053345.png" alt="THUNDER KING" style="width:85%">
      <h1>THUNDER KING</h1>
      <p class="price"><?php
